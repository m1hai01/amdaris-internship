    ...
    <div className="App">
      ...
      <UnauthenticatedTemplate>
        ...
        >
          ...
          />
          <Typography sx={{ display: "flex" }}>Sign in</Typography>
          <svg
      ...
      <UnauthenticatedTemplate>
        ...
        >
          <img
            ...
            style={{ height: "60px", width: "80px" }}
          />
          <Typography sx={{ display: "flex" }} fontSize={22}>
            Sign in
          </Typography>
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <Router>
        <Routes>
          <Route element={<AuthorizeRoutes />}>
            ...
            <Route path="/patients/:patientId" element={<ProfilePatient />} />
